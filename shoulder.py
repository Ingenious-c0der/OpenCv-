...
def get_shoulder_width(image, shoulder_pixels:int, actual_dimensions=1.98, points=8) -> float:
    ...
    return (omega_shoulder_width + (2 * shoulder_width_new) + shoulder_width + shoulder_width_2 + shoulder_width_avg) / 6
